This code implements a Pricing Engine design problem as described below.  By default it will process input1.txt by running PricingEngineRunner. Alternatively, the path to an external file can be supplied as an command line argument.

Requires Java 8. Being an exercise, debug logging was done with System.out's and commented instead of a logging framework.
